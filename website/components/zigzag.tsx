            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <p className="text-xl text-gray-400 mb-4">Combine existing digital hobbies with outdoor activities to create engaging, modern play experiences for youth. By integrating technology into traditional games like hide and seek, we motivate kids to move and explore outdoors, offering digital rewards for their physical activities.</p>
